...
<Steps>
  ...
  <Step title="Create an OAuth application">
    ...
    - **Redirect URIs**: Your OAuth callback URL (e.g. `http://localhost:8000/api/v1/oauth/oura/callback` for local development)
...
OURA_REDIRECT_URI=http://localhost:8000/api/v1/oauth/oura/callback
...
```
    ...
    **Configuration details:**
    ...
    | `OURA_REDIRECT_URI` | Must match a redirect URI registered in the Developer portal. For local dev: `http://localhost:8000/api/v1/oauth/oura/callback` |
  ...
  <Step title="Set up webhooks (optional)">
    ...
    **1. Register subscriptions:**
    ...
    ```
    https://your-ngrok-subdomain.ngrok.io/api/v1/oura/webhooks
    ```
