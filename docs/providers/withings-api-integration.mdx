...
| Sleep | Nightly summary: total duration, time in bed, efficiency, deep/light/REM/awake totals, nap flag, the night's lowest heart rate (stored as resting heart rate) | Yes |
