...
| Sleep | Nightly summary: total duration, time in bed, efficiency, deep/light/REM/awake totals, nap flag, plus the stage timeline from Sleep v2 - Get | Yes |
...
Not imported today: sleep score, HRV, ECG, segmental body composition, visceral fat, nerve health scores.
