...
| Cycle aggregates (daily strain, energy, steps) | Yes — scored cycles only; energy (kcal) and steps are per-cycle totals stored as daily values on the cycle start date (a Whoop cycle is not a midnight-to-midnight day) |
