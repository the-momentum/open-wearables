...
<Accordion title="Polar">
  **Integration Method:** OAuth 2.0 (pull-based polling)
  ...
  - No webhooks; data is synced via periodic polling only
  ...
  - HRV RMSSD available from Elixir SpO2 spot tests and wrist ECG measurements; not available from standard devices
  - 75+ workout type mappings to unified taxonomy
  - Exercises accessible via transaction-based endpoint (last 30 days only)
</Accordion>
