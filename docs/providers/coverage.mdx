...
description: "Data types by provider: Apple, Garmin, Polar, Suunto, Oura, Whoop, Ultrahuman, Strava, and Sensor Bio. OAuth, workouts, sleep, and timeseries support."
...
"og:description": "Health data types by provider: Apple, Garmin, Polar, Suunto, Oura, Whoop, Ultrahuman, Strava, Sensor Bio."
"og:url": "https://docs.openwearables.io/providers/coverage"
"og:type": "article"
"twitter:title": "Wearable API Coverage Matrix | Open Wearables"
"twitter:description": "Health data types by provider: Apple, Garmin, Polar, Suunto, Oura, Whoop, Ultrahuman, Strava, Sensor Bio."
...
| Capability | Apple | Garmin | Polar | Suunto | Oura | Whoop | Ultrahuman | Strava | Sensor Bio |
|------------|:-----:|:------:|:-----:|:------:|:----:|:-----:|:----------:|:------:|:----------:|
| **OAuth** | ❌ | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ |
| **Workouts** | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ❌ | ✅ | ✅ |
| **Sleep** | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ❌ | ✅ |
...
| Data Type | Unit | Apple | Garmin | Polar | Suunto | Oura | Whoop | Ultrahuman | Strava | Sensor Bio |
|-----------|------|:-----:|:------:|:-----:|:------:|:----:|:-----:|:----------:|:------:|:----------:|
| `heart_rate` | bpm | ✅ | ✅ | ✅ | ✅ | ✅ | ❌ | ✅ | ❌ | ✅ |
...
| Feature | Apple | Garmin | Polar | Suunto | Oura | Whoop | Ultrahuman | Strava | Sensor Bio |
|---------|:-----:|:------:|:-----:|:------:|:----:|:-----:|:----------:|:------:|:----------:|
| Sleep sessions | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ❌ | ✅ |
| Total duration | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ❌ | ✅ |
| Time in bed | ✅ | ❌ | ✅ | ✅ | ✅ | ✅ | ✅ | ❌ | ✅ |
...
| Score | Internal | Apple | Garmin | Polar | Suunto | Oura | Whoop | Ultrahuman | Strava | Sensor Bio |
|-------|:--------:|:-----:|:------:|:-----:|:------:|:----:|:-----:|:----------:|:------:|:----------:|
| Sleep score | 🔜 | ❌ | ✅ | ✅ | ❌ | ✅ | ✅ | ❌ | ❌ | ✅ |
| Readiness score | ❌ | ❌ | ❌ | ◐ | ❌ | ✅ | ❌ | ❌ | ❌ | ❌ |
| Activity score | ❌ | ❌ | ❌ | ❌ | ❌ | ✅ | ❌ | ❌ | ❌ | ✅ |
...
<Accordion title="Sensor Bio">
  **Integration Method:** OAuth 2.0 (REST pull, HTTP/2 required)

  - All API requests must use HTTP/2; the integration enforces this via the `http2=True` flag on the underlying httpx client
  - Continuous 24/7 timeseries: heart rate (RMSSD HRV), SpO2, and respiratory rate sampled at irregular intervals — data is epoch-seconds based but the API returns millisecond timestamps in some endpoints; normalisation handles both
  - Daily activity: steps, energy, and distance fetched via `/v1/step/details` with cursor-based pagination using `WorkoutStats.timestamp` (milliseconds)
  - Workouts fetched from `/v1/activities` with cursor pagination; `likely_name` field is used to infer workout type (no dedicated type field)
  - Sleep data: full stage breakdown (deep, light, REM, awake) and efficiency score; sleep biometrics (HR, HRV during sleep) are not yet extracted
  - Health scores from `/v1/scores`: sleep score, activity score, and recovery score (RMSSD-based) all persisted as `HealthScore` records
  - Nap detection heuristic: sessions shorter than 3 hours are tagged as naps
  - No webhook support — sync is pull-only; schedule periodic sync jobs for continuous data freshness
</Accordion>
