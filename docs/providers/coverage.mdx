...
<Accordion title="Oura">
  **Integration Method:** OAuth 2.0 + Webhooks
  ...
  - Webhooks push real-time notifications for: daily activity, daily readiness, daily sleep, daily SpO2, daily stress, and workouts
  ...
  - Daily stress sync uses the `stress` OAuth scope and stores Oura's stress summary plus high-stress/recovery durations as a stress score
