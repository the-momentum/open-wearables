...
| Meals (nutrition-log: energy, macros, sodium/potassium/cholesterol, meal type, food name) | Sessions |
...
curl -X POST \
  ...
  -d '{
    ...
    "subscriberConfigs": [
      {"dataTypes": ["steps", "distance", "heart-rate", "sleep", "exercise", "nutrition-log"], "subscriptionCreatePolicy": "AUTOMATIC"}
    ],
...
daily-respiratory-rate, daily-oxygen-saturation, sleep, exercise, nutrition-log). Registering
