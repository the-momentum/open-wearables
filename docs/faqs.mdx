...
More providers are being added regularly. Check the [provider setup guides](/provider-setup/suunto) for the latest list, or view the current status of provider requests and implementations on [GitHub Issues](https://github.com/the-momentum/open-wearables/issues?q=is%3Aissue+label%3Aprovider-request) tagged with `provider-request`.
...
- Embeddable widgets for easy integration (comming soon)
