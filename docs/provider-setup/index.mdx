...
|----------|-------------|--------|
| **Suunto** | [Setup Guide →](/provider-setup/suunto) | You must apply for [Suunto Developer Program](https://www.suunto.com/en-gb/partners/partners/) |
| **Garmin** | [Setup Guide →](/provider-setup/garmin) | You must apply for [Garmin Developer Program](https://developer.garmin.com/) |
| **Polar** | [Setup Guide →](/provider-setup/polar) | You must register for the [Polar API program](https://www.polar.com/en/business/api) |
| **Fitbit** | — | Coming soon |
...
| Provider | Setup Guide | Notes |
|----------|-------------|--------|
| **Apple Health** | [Setup Guide →](/provider-setup/apple-health) | Mobile SDK coming soon! |
