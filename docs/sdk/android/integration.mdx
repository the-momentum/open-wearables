---
title: "Android Health Connect Integration Guide"
...
<Info>
  Read the [Mobile SDK Integration Guide](/sdk/integration) first. It covers what is the same on every platform: authentication, the backend token endpoint, the SDK lifecycle, and the production checklist. This page shows the Kotlin code for each step.
</Info>
...
class MyApplication : Application() {
    ...
    override fun onCreate() {
        ...
        sdk.authErrorListener = { statusCode, message ->
            Log.e("HealthSDK", "Auth error $statusCode: $message")
        }
...
| Foreground Service | Used during active sync for reliability (`health` type) |
