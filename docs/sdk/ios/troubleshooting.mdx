---
title: "iOS HealthKit SDK Troubleshooting"
...
<Tip>
  For critical sync operations, prompt users to open the app — the SDK resumes an interrupted sync when the app returns to the foreground.
</Tip>
...
<CardGroup cols={2}>
  <Card title="GitHub Issues" icon="github" href="https://github.com/the-momentum/OpenWearablesHealthSDK/issues">
