...
<Card title="GitHub Repository" icon="github" href="https://github.com/the-momentum/health-bg-sync">
...
<CardGroup cols={2}>
  ...
  <Card title="API Reference" icon="code" href="https://github.com/the-momentum/health-bg-sync#api-reference">
