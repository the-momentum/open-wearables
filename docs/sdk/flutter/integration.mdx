...
<Warning>
  **Never embed your API Key in the mobile app.** The API Key should only exist on your backend server.
</Warning>
...
<CardGroup cols={2}>
  ...
  <Card title="Data Types" icon="database" href="/api-reference/guides/data-types">
