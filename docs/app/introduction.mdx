...
description: "Sync Apple Health and Android health data with Open Wearables using our mobile app."
---

## Overview

The Open Wearables app lets you sync health data from your phone to any Open Wearables instance. Install it on your device, enter an invitation code, and Apple Health or Android health data starts flowing automatically.
