...
This page lists all supported data types, units, and formats. For provider-specific availability, see the [Provider Coverage Matrix](/api-reference/guides/provider-coverage).

<Tip>
  Not all providers support all data types. Check the [Provider Coverage Matrix](/api-reference/guides/provider-coverage) to see which metrics are available from each wearable device.
</Tip>
...
<Card title="Full Provider Coverage Matrix" icon="table" href="/api-reference/guides/provider-coverage">
