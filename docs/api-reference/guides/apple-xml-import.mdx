...
See [Data Types Guide](/api-reference/guides/data-types) for complete list.
...
- [Apple Health Setup Guide](/provider-setup/apple-health) - Complete guide with export instructions
