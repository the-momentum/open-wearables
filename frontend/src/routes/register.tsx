...
import { Activity, Zap, Shield, TrendingUp, Eye, EyeOff } from 'lucide-react';
          ...
          <div className="hidden lg:block space-y-8 text-white">
            <div className="space-y-4">
              ...
              <p className="text-lg text-slate-300 max-w-lg">
                Create your developer account and start integrating health data
                from any wearable device through our unified API.
              </p>
            </div>
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <div className="group p-6 rounded-2xl bg-white/5 backdrop-blur-sm border border-white/10 hover:bg-white/10 transition-all duration-300 hover:scale-105 col-span-2">
                ...
                <h3 className="font-semibold mb-1">Free Tier Available</h3>
                <p className="text-sm text-slate-400">
                  Start free with 1,000 API calls per month
                </p>
              </div>
            </div>
          </div>
