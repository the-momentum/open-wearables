...
- **Exercise the change by hand.** Call the endpoint, click through the flow, sync against a real provider account - whatever your change touches. A green test suite is not the same thing as a working feature.
...
The full checklist lives in the [Pull Request Guidelines](./contributing/pull-requests.md).
