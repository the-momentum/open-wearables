...
from app.tests.utils import api_key_headers, create_api_key, create_developer, create_user, developer_auth_headers
...
class TestListUsers:
    ...
    def test_list_users_success(self, client: TestClient, db: Session, api_v1_prefix: str):
        ...
        user1 = create_user(db, email="user1@example.com", first_name="John", last_name="Doe")
        user2 = create_user(db, email="user2@example.com", first_name="Jane", last_name="Smith")
...
class TestGetUser:
    ...
    def test_get_user_success(self, client: TestClient, db: Session, api_v1_prefix: str):
        ...
        developer = create_developer(db, email="test@example.com", password="test123")
        api_key = create_api_key(db, developer=developer)
        user = create_user(db, email="user@example.com", first_name="John", last_name="Doe")
        headers = api_key_headers(api_key.id)
...
class TestUpdateUser:
    ...
    def test_update_user_email(self, client: TestClient, db: Session, api_v1_prefix: str):
        ...
        # Arrange
        developer = create_developer(db, email="test@example.com", password="test123")
        user = create_user(db, email="old@example.com", first_name="John")
    ...
    def test_update_user_name(self, client: TestClient, db: Session, api_v1_prefix: str):
        ...
        # Arrange
        developer = create_developer(db, email="test@example.com", password="test123")
        user = create_user(db, first_name="John", last_name="Doe")
        headers = developer_auth_headers(developer.id)
    ...
    def test_update_user_external_id(self, client: TestClient, db: Session, api_v1_prefix: str):
        ...
        # Arrange
        developer = create_developer(db, email="test@example.com", password="test123")
        user = create_user(db, external_user_id="old_id")
        headers = developer_auth_headers(developer.id)
    ...
    def test_update_user_empty_payload(self, client: TestClient, db: Session, api_v1_prefix: str):
        ...
        # Arrange
        developer = create_developer(db, email="test@example.com", password="test123")
        user = create_user(db, email="user@example.com", first_name="John")
        headers = developer_auth_headers(developer.id)
        payload = {}
    ...
    def test_update_user_requires_bearer_token(self, client: TestClient, db: Session, api_v1_prefix: str):
        ...
        # Assert - API key auth should fail for this endpoint
        assert response.status_code == 401
