...
from app.tests.utils import create_api_key, create_developer, developer_auth_headers
...
class TestListApiKeys:
    ...
    def test_list_api_keys_success(self, client: TestClient, db: Session, api_v1_prefix: str):
        ...
        api_key1 = create_api_key(db, developer=developer, name="Key 1")
        api_key2 = create_api_key(db, developer=developer, name="Key 2")
    ...
    def test_list_api_keys_only_shows_own_keys(self, client: TestClient, db: Session, api_v1_prefix: str):
        """Test that developer only sees their own API keys."""
        # Arrange
        ...
        key1 = create_api_key(db, developer=developer1, name="Dev1 Key")
        key2 = create_api_key(db, developer=developer2, name="Dev2 Key")
...
class TestDeleteApiKey:
    ...
    def test_delete_api_key_success(self, client: TestClient, db: Session, api_v1_prefix: str):
        ...
        # Arrange
        developer = create_developer(db, email="test@example.com", password="test123")
        api_key = create_api_key(db, developer=developer, name="To Delete")
        headers = developer_auth_headers(developer.id)
        key_id = api_key.id
...
class TestUpdateApiKey:
    ...
    def test_update_api_key_name(self, client: TestClient, db: Session, api_v1_prefix: str):
        ...
        # Arrange
        developer = create_developer(db, email="test@example.com", password="test123")
        api_key = create_api_key(db, developer=developer, name="Old Name")
        headers = developer_auth_headers(developer.id)
    ...
    def test_update_api_key_empty_payload(self, client: TestClient, db: Session, api_v1_prefix: str):
        ...
        # Arrange
        developer = create_developer(db, email="test@example.com", password="test123")
        api_key = create_api_key(db, developer=developer, name="Original Name")
        headers = developer_auth_headers(developer.id)
        payload = {}
...
class TestRotateApiKey:
    ...
    def test_rotate_api_key_success(self, client: TestClient, db: Session, api_v1_prefix: str):
        ...
        # Arrange
        developer = create_developer(db, email="test@example.com", password="test123")
        old_api_key = create_api_key(db, developer=developer, name="To Rotate")
        headers = developer_auth_headers(developer.id)
        ...
        assert response.status_code == 201
        data = response.json()
        assert data["name"] == "To Rotate"  # Name should be preserved
    ...
    def test_rotate_preserves_key_name(self, client: TestClient, db: Session, api_v1_prefix: str):
        """Test that rotation preserves the original key name."""
        # Arrange
        developer = create_developer(db, email="test@example.com", password="test123")
        old_api_key = create_api_key(db, developer=developer, name="Production Key")
        headers = developer_auth_headers(developer.id)
    ...
    def test_rotate_multiple_times(self, client: TestClient, db: Session, api_v1_prefix: str):
        ...
        # Arrange
        developer = create_developer(db, email="test@example.com", password="test123")
        api_key = create_api_key(db, developer=developer, name="Multi Rotate")
        headers = developer_auth_headers(developer.id)
