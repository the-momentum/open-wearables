...
class TestSuuntoStrategy:
    ...
    def test_strategy_initializes_repositories(self):
    ...
    def test_strategy_initializes_oauth_component(self):
    ...
    def test_strategy_initializes_workouts_component(self):
    ...
    def test_workouts_component_receives_repositories(self):
    ...
    def test_oauth_component_receives_repositories(self):
