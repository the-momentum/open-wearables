...
class TestDataPointSeriesRepository:
    ...
    def test_create_with_existing_mapping(self, db: Session, series_repo: DataPointSeriesRepository):
        ...
        # series_type_id should be set from series_type
    ...
    def test_get_samples_by_device_id(self, db: Session, series_repo: DataPointSeriesRepository):
        ...
        for i in range(3):
            sample = TimeSeriesSampleCreate(
                ...
                provider_id="apple",
                device_id="device1",
                external_mapping_id=mapping1.id,
        ...
        sample = TimeSeriesSampleCreate(
            ...
            provider_id="apple",
            device_id="device2",
            external_mapping_id=mapping2.id,
            recorded_at=now,
            value=80,
            series_type=SeriesType.heart_rate,
        )
    ...
    def test_get_samples_by_external_mapping_id(self, db: Session, series_repo: DataPointSeriesRepository):
        ...
        query_params = TimeSeriesQueryParams(external_mapping_id=mapping.id)
    ...
    def test_get_samples_by_provider(self, db: Session, series_repo: DataPointSeriesRepository):
        ...
        # Arrange
        user = create_user(db)
        mapping_apple = create_external_device_mapping(db, user=user, provider_id="apple", device_id="device1")
        mapping_garmin = create_external_device_mapping(db, user=user, provider_id="garmin", device_id="device1")
        ...
        sample1 = TimeSeriesSampleCreate(
            ...
            provider_id="apple",
            device_id="device1",
            external_mapping_id=mapping_apple.id,
            recorded_at=now,
            value=72,
            series_type=SeriesType.heart_rate,
        )
        ...
        sample2 = TimeSeriesSampleCreate(
            ...
            provider_id="garmin",
            device_id="device1",
            external_mapping_id=mapping_garmin.id,
            recorded_at=now,
            value=75,
            series_type=SeriesType.heart_rate,
        )
        ...
        query_params = TimeSeriesQueryParams(device_id="device1", provider_id="apple")
    ...
    def test_get_samples_filters_by_user(self, db: Session, series_repo: DataPointSeriesRepository):
        ...
        mapping2 = create_external_device_mapping(db, user=user2, device_id="device1")
