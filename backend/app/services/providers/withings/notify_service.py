...
class WithingsNotifyService:
    ...
    def subscribe_user(
        ...
        return self._apply("subscribe", "subscribed", db, user_id, connection_repo, oauth, callback_url)
    ...
    def revoke_user(
        ...
        return self._apply("revoke", "revoked", db, user_id, connection_repo, oauth, callback_url)
