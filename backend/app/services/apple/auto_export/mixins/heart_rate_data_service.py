...
class HeartRateDataService(
    ...
    def __init__(self, log: Logger, **kwargs):
        super().__init__(crud_model=HeartRateDataRepository, model=HeartRateData, log=log, **kwargs)
    ...
    async def get_heart_rate_data_with_filters(
        ...
        data, total_count = self.crud.get_heart_rate_data_with_filters(db_session, query_params, user_id)
