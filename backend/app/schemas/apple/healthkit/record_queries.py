...
class RecordQueryParams(BaseQueryParams):
    ...
    record_type: str | None = Field(
        None,
        description="Record type (e.g., 'HKQuantityTypeIdentifierStepCount', 'HKQuantityTypeIdentifierHeartRate')",
    )
    source_name: str | None = Field(None, description="Source name of the record (e.g., 'Apple Watch', 'iPhone')")
    unit: str | None = Field(None, description="Unit of measurement (e.g., 'count', 'bpm', 'cal')")
