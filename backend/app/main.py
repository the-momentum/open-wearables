...
from app.utils.exceptions import ResourceNotFoundError, handle_exception
...
async def resource_not_found_exception_handler(_: Request, exc: ResourceNotFoundError) -> None:
    raise handle_exception(exc, "")
