...
SUUNTO_WORKOUT_TYPE_MAPPINGS: list[tuple[int, str, WorkoutType]] = [
    ...
    # Generic Sports (4-9)
    (4, "Sports", WorkoutType.SPORT),
    (5, "Sports", WorkoutType.SPORT),
    (6, "Sports", WorkoutType.SPORT),
    (7, "Sports", WorkoutType.SPORT),
    (8, "Sports", WorkoutType.SPORT),
    (9, "Sports", WorkoutType.SPORT),
    ...
    (18, "Parkouring", WorkoutType.PARKOUR),
    (19, "Ball games", WorkoutType.TEAM_SPORTS),
    ...
    (28, "Water sports", WorkoutType.WATER_SPORTS),
    ...
    (41, "Racquet ball", WorkoutType.RACQUETBALL),
    ...
    (46, "Bowling", WorkoutType.BOWLING),
    (47, "Cricket", WorkoutType.CRICKET),
    ...
    (66, "Frisbee golf", WorkoutType.DISC_SPORTS),
    ...
    (88, "Paragliding", WorkoutType.PARAGLIDING),
    ...
    (96, "Fishing", WorkoutType.FISHING),
    (97, "Hunting", WorkoutType.HUNTING),
    ...
    (108, "Wheelchair sport", WorkoutType.PARA_SPORTS),
