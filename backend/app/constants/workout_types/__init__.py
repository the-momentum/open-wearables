...
from .sdk import SDKWorkoutType
from .sdk import get_activity_name as get_activity_name_sdk
from .sdk import get_unified_workout_type as get_unified_sdk_workout_type
...
__all__ = [
    ...
    "get_activity_name_sdk",
    "get_unified_sdk_workout_type",
