...
from app.schemas import AEHeartRateDataCreate, AEHeartRateDataUpdate


class HeartRateDataRepository(
    CrudRepository[HeartRateData, AEHeartRateDataCreate, AEHeartRateDataUpdate], BaseHeartRateRepository[HeartRateData]
):
