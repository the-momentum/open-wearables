...
def test_normalize_measures_skips_unmapped_types() -> None:
    d = _make_data_247()
    groups = [{"date": 1728000000, "measures": [{"value": 1, "type": 99999, "unit": 0}]}]
    assert d.normalize_measures(groups, uuid4()) == []
