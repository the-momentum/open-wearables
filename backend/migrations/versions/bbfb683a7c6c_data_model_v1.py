...
def upgrade() -> None:
    ...
    op.create_table('series_type_definition',
    ...
    op.create_table('external_device_mapping',
    ...
    op.create_index('idx_data_point_series_mapping_type_time', 'data_point_series', ['external_mapping_id', 'series_type_id', 'recorded_at'], unique=False)
    ...
    sa.ForeignKeyConstraint(['external_mapping_id'], ['external_device_mapping.id'], ondelete='CASCADE'),
    sa.PrimaryKeyConstraint('id'),
    sa.UniqueConstraint('external_mapping_id', 'start_datetime', 'category', name='uq_event_record_datetime_category')
    )
    op.create_index('idx_event_record_mapping_category', 'event_record', ['external_mapping_id', 'category'], unique=False)
    op.create_index('idx_event_record_mapping_time', 'event_record', ['external_mapping_id', 'start_datetime', 'end_datetime'], unique=False)
