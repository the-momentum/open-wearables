...
def upgrade() -> None:
    ...
    op.alter_column('series_type_definition', 'code',
...
def downgrade() -> None:
    ...
    op.add_column('workout_details', sa.Column('steps_avg', sa.NUMERIC(precision=10, scale=3), autoincrement=False, nullable=True))
